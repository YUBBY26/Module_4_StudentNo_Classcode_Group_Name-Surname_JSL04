...
console.log(`This user preference is set to ${userPreference === undefined ? 'Regular' : 'Sugar-free'}`);
...
console.log(currentHour >= 7 && randomHour ? `Unleash the beast!` : `Better stick to water.`);
